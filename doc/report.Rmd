...
```{r EDA1 Line Plots, echo=FALSE, fig.cap = 'Mean aggregate scores for Numeracy and Reading sections of the FSA exam by school type and subgroup (Yellow pairs: Numeracy test,  Blue pairs: Reading test; Bright ones:BC Independent Schools, Dim ones: BC Public Schools)', fig.align='center', out.width='60%', out.height='60%'}
...
```{r Q1 Numeracy Boxplot, echo=FALSE, fig.cap = 'Boxplots of mean aggregate scores for Numeracy and Reading sections of the FSA exam by school type (BC Independent School / BC Public School)'}
knitr::include_graphics('../img/boxplot_pi.png')
```
...
```{r EDA2 Bar Plots, echo=FALSE, fig.cap = 'Mean aggregate scores for Numeracy and Reading sections of the FSA exam by subgroup (Aboriginal / Non Aboriginal)', fig.align='center', out.width='80%', out.height='80%'}
knitr::include_graphics(c('../img/plots_ab.png'))
```


```{r EDA2 Line Plots, echo=FALSE, fig.cap = 'Mean aggregate scores for Numeracy and Reading sections of the FSA exam by subgroup (Yellow pairs: Numeracy test,  Blue pairs: Reading test; Bright ones:Non aboriginal, Dim ones: Aboriginal)', fig.align='center', out.width='60%', out.height='60%'}
...
```{r Q2 Numeracy Boxplot, echo=FALSE, fig.cap = 'Boxplots of mean aggregate scores for Numeracy and Reading sections of the FSA exam by subgroup (Aboriginal / Non Aboriginal)'}
knitr::include_graphics('../img/boxplot_ana.png')
```
