...
```{r EDA1 Line Plots, echo=FALSE, fig.cap = 'Mean aggregate scores for Numeracy and Reading sections of the FSA exam by school type and subgroup (Yellow pairs: Numeracy test,  Blue pairs: Reading test; Bright ones:BC Independent Schools, Dim ones: BC Public Schools)', out.height='60%'}
...
```{r EDA2 Line Plots, echo=FALSE, fig.cap = 'Mean aggregate scores for Numeracy and Reading sections of the FSA exam by subgroup (Yellow pairs: Numeracy test,  Blue pairs: Reading test; Bright ones:Non aboriginal, Dim ones: Aboriginal)', out.height='60%'}
