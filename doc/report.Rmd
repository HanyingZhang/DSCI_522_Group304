...
Fig: Mean aggregate scores for Numeracy and Reading sections of the FSA exam by school type and subgroup (Yellow pairs: Numeracy test,  Blue pairs: Reading test; Bright ones:BC Independent Schools, Dim ones: BC Public Schools)

```{r EDA1 Line Plots, echo=FALSE, out.width='60%', out.height='60%', fig.align='center'}
knitr::include_graphics(c('../img/line_pub_ind.png'))
```
...
Fig: Mean aggregate scores for Numeracy and Reading sections of the FSA exam by subgroup (Yellow pairs: Numeracy test,  Blue pairs: Reading test; Bright ones:Non aboriginal, Dim ones: Aboriginal)

```{r EDA2 Line Plots, echo=FALSE, out.width='60%', out.height='60%', fig.align='center'}
